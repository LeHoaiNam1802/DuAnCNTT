...
@PostMapping("/seacher")
    public String seacher(Model model, Principal principal,@RequestParam(name = "name") String name) {
...
//        https://stackoverflow.com/questions/53375549/spring-1-form-2-entities
        ...
        model.addAttribute("listStudent", studentRepository.findByName(name));
